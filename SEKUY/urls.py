...
urlpatterns = [
    ...
    # Link Materi
    path('materi/tambahmateri/', AddMateri, name="create"),
    path('materi/', ListMateri, name="materi"),
    url(r'materi/delete(?P<hapus_id>[0-9]+)$', hapusMateri, name="hapusMateri"),
    url(r'materi/update/(?P<update_id>[0-9]+)$', updateMateri, name='updateMateri'),

    # Link VideoPembelajaran
    path('Video-Pembelajaran/', videoPembelajaran)
]
